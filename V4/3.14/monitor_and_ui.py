...
twilio_frame = ttk.Frame(notebook, width=1000, height=700)
...
# URLs to Monitor Tab
urls_frame = ttk.Frame(notebook, width=1000, height=700)
...
# Proxy Settings Tab
proxy_frame = ttk.Frame(notebook, width=1000, height=700)
...
# Mailbox Check Tab
mail_frame = ttk.Frame(notebook, width=1000, height=700)
...
# Silence Period Tab
silence_frame = ttk.Frame(notebook, width=1000, height=700)
...
eval_frame = ttk.Frame(notebook, width=1000, height=700)
